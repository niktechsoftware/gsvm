            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                          <div class ="alert alert-info"> <h3>Diagnosis of Disease  Details between <?php echo $sdate ;?> to <?php echo $edate;?></h3></div>
                        ...
                        ?>
                          <tr>
                           ...
                           <input type="hidden" id ="reg_id<?php echo $i;?>" value="<?php echo $data->id;?>" />
                            ...
                            <td><a href="<?php echo base_url();?>index.php/customer/editproforma/<?php echo $data->id;?>/<?php echo $sspid ;?>"><?php echo $res->date;?></a>
