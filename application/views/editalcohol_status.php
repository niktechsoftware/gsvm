				...
				<div class="col-xs-12 col-md-12 col-lg-12">
					<div class="card">
						<div class="card-header">
							<h4>Patient Alcohol Status</h4>

						</div>
						<form method="post"	action="<?php echo base_url()?>index.php/customer/update_alcoholstatus" enctype="multipart/Form-data" >
													...
													<div class="col-md-2">
														<div class="form-group">
															YES<input type="radio" class="form-control"
																name="answer" value="<?php echo $as->row()->drinking_alcohol;?>" style="height:20px; width:20px;">
