                    ...
                    <!-- tree Content -->
					         	...
					         	<?php 
										    	$data=$crecord->row();
															...
															?>
																...
																if($stree->num_rows()>0){
																    if($stree->row()->left){ 
																         $this->db->where("id", $stree->row()->left);
																    ...
																    if($stree->row()->right){
																         $this->db->where("id", $stree->row()->right);
                                                                        $data1 = $this->db->get("customer_info")->row();
                                                                        if($data1->status){
                                                                            $count1=1;
                                                                            //echo $query2->root_left."<br>";
																...
																$ct= $this->tree->countlegleft($stree->row()->left,$count); 
																
																$cleft= " Total Left = ".$ct;
																
																$critt= $this->tree->countlegrit($stree->row()->right,$count1); 
																$cright= "Total Right = ".$critt;
																if($ct<$critt){
																    $pair="Total Pair = ".$ct;
																}
																else{
																    $pair="Total Pair = ".$critt;
																}
																}
																
																	?>
					         
					         <div class=" alert alert-success"> <?= $cleft. " and ".$cright." and ".$pair; ?></div>
					 ...
					 <form action="<?php echo base_url(); ?>index.php/clogin/binarySubGroup" method="post">
	                        ...
	                        <div class="row">
									...
									<div class="col-2"><input type="submit" class="btn btn-danger" value="Get Tree" /></div>
									<div class="col-2"><a href="<?= base_url() ?>index.php/clogin/tree" class="btn btn-danger">Root</a></div>
										</div>
